...
//!
//!   1) cargo run --package timely --example rescaling_broadcast -- -n2 -w2 -p0
//!   2) cargo run --package timely --example rescaling_broadcast -- -n2 -w2 -p1
//!
//! After a bit..
//!
//!   3) cargo run --package timely --example rescaling_broadcast -- -n2 -w2 -p2 --join 0 --nn 3
//!
